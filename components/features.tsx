          ...
          <div className="text-left max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-2 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 mb-2">
                With Bakkhos, you get access to some of the <span className='text-purple-400 font-bold'>best hackers 
                ...
                CTFs are the <span className='text-purple-400 font-bold'>Olympics of Cybersecurity</span>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400">
                CTF isn't about guessing the right attack vector. It's about <span className='text-purple-400 font-bold'>learning how to think like a 
                hacker.</span> We've designed our challenges to be <span className='text-purple-400 font-bold'>fun and engaging</span>,
